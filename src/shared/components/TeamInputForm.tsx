...
import TeamStatInput from "@/shared/components/TeamStatInput";
import PredictIcon from "@/shared/components/icons/PredictIcon";
import { type Team, type Player } from "@/shared/utils/types";
import TeamDisplay from "@/shared/components/TeamDisplay";
    ...
    <section className="mb-8 md:mb-10">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 mb-6 md:mb-8">
        ...
        >
          <Card className="border-0 shadow-xl bg-gradient-to-br from-blue-50/50 to-indigo-50/50 dark:from-blue-900/20 dark:to-indigo-900/20 backdrop-blur-sm hover:shadow-2xl transition-all duration-300">
            <CardHeader className="pb-3 md:pb-4">
              <CardTitle className="flex items-center text-blue-600 dark:text-blue-400 text-lg md:text-xl">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 md:h-6 md:w-6 mr-1.5 md:mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        >
          <Card className="border-0 shadow-xl bg-gradient-to-br from-red-50/50 to-orange-50/50 dark:from-red-900/20 dark:to-orange-900/20 backdrop-blur-sm hover:shadow-2xl transition-all duration-300">
            <CardHeader className="pb-3 md:pb-4">
              <CardTitle className="flex items-center text-red-600 dark:text-red-400 text-lg md:text-xl">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 md:h-6 md:w-6 mr-1.5 md:mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      >
        <Button 
          ...
          className="w-full max-w-md py-4 md:py-6 text-base md:text-lg font-bold relative overflow-hidden group bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 transition-all duration-300 rounded-xl shadow-lg transform hover:scale-105 active:scale-95"
        >
          {isLoading ? (
            ...
            <>
              <PredictIcon className="mr-2 h-5 w-5 md:h-6 md:w-6" />
              <span className="text-sm md:text-base">PREDICT MATCH RESULT</span>
